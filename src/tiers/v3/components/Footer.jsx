    ...
    <footer className="relative z-10 border-t border-white/5">
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div>
            <Link to={BASE} className="font-display font-bold text-2xl tracking-wider" style={{ color: ACCENT }}>
              CMM
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                { label: 'For Rookies', path: `${BASE}/rookies` },
                { label: 'Medical Advisory', path: `${BASE}/medical` },
                { label: 'Terms', path: `${BASE}/terms` },
                { label: 'Privacy', path: `${BASE}/privacy` },
              ].map(l => (
                <li key={l.label}>
                  <Link to={l.path} className="text-sm text-white/40 hover:text-white/70 transition-colors">{l.label}</Link>
                </li>
        ...
        <div className="border-t border-white/5 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            <Link to={`${BASE}/refund`} className="text-xs text-white/20 hover:text-white/40 transition-colors">Refund Policy</Link>
            <Link to={`${BASE}/privacy`} className="text-xs text-white/20 hover:text-white/40 transition-colors">Privacy</Link>
            <Link to={`${BASE}/terms`} className="text-xs text-white/20 hover:text-white/40 transition-colors">T&C</Link>
          </div>
        </div>
      </div>
    </footer>
