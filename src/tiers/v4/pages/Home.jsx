...
const PARTNERS = [
  { src: 'https://bangalore.bharatmidnightmarathon.run/wp-content/uploads/sites/10/2024/07/Title-312x148.png', tier: 'Title' },
  { src: 'https://bangalore.bharatmidnightmarathon.run/wp-content/uploads/sites/10/2025/10/Associate-Partner-611x278.png', tier: 'Associate Partner' },
  { src: 'https://bangalore.bharatmidnightmarathon.run/wp-content/uploads/sites/10/2024/12/Official-Healthcare-Partner-299x142.png', tier: 'Official Healthcare Partner' },
  { src: 'https://bangalore.bharatmidnightmarathon.run/wp-content/uploads/sites/10/2025/11/Half-Marathon-Partner-768x383.png', tier: 'Half Marathon Partner' },
  { src: 'https://bangalore.bharatmidnightmarathon.run/wp-content/uploads/sites/10/2024/10/316K-Run-Partner-768x300.png', tier: '31.6K Run Partner' },
  { src: 'https://bangalore.bharatmidnightmarathon.run/wp-content/uploads/sites/10/2025/10/10k-Run-Partner-768x379.png', tier: '10K Run Partner' },
]
    ...
    <>
      ...
      <section style={{
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} style={{ textAlign: 'center', padding: '40px 24px' }}>
          <img src="https://bangalore.bharatmidnightmarathon.run/wp-content/uploads/sites/10/2025/11/WhatsApp-Image-2025-11-28-at-12.07.42-PM-768x345.jpeg" alt="Marathon Banner" style={{ maxWidth: '100%', width: 768, borderRadius: 4 }} />
